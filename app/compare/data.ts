...
export const competitors: Competitor[] = [
  {
    ...
    summary: 'Tradify is a solid job management platform for larger teams that need timesheets and crew management. QuoteMate covers the day-to-day basics — quoting, invoicing, and job scheduling with Google Calendar sync — and pulls ahead on speed with AI-powered material suggestions and real-time supplier pricing, at a fraction of the cost.',
  },
  {
    slug: 'servicem8',
    name: 'ServiceM8',
    ...
    summary: 'ServiceM8 is a comprehensive field service platform ideal for businesses managing crews and complex dispatch. QuoteMate is purpose-built for fast, accurate quoting — describe any job, get an AI-generated materials list with live supplier pricing, schedule it to Google Calendar, and send the quote — all for a simple flat rate.',
  },
  {
    slug: 'fergus',
    name: 'Fergus',
    ...
    summary: 'Fergus offers deep job management with detailed job costing across many suppliers. QuoteMate wins on speed and simplicity — AI material suggestions, real-time pricing, job scheduling, and purchase orders straight to Reece — in under 2 minutes per quote, at about half the monthly cost.',
  },
  {
    slug: 'chatgpt',
