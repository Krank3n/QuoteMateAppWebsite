      ...
      <div className="container">
        ...
        <div className="footer-bottom">
          <div className="footer-badges">
            <a href="https://apps.apple.com/au/app/quotemate/id6754000046" className="btn btn-store btn-store-xs" aria-label="Download QuoteMate on the App Store" target="_blank" rel="noopener noreferrer">
