      ...
      <div className="container">
            ...
            <ul>
              ...
              <li>
                <div className="social-links">
                  ...
                  <a href="https://www.youtube.com/@QuoteMateApp/" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
        ...
        <div className="footer-bottom">
          <div className="footer-badges">
            <a href="https://apps.apple.com/au/app/quotemate/id6754000046?pt=128219706&ct=website&mt=8" className="btn btn-store btn-store-xs" aria-label="Download QuoteMate on the App Store" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.quotemate.app&hl=en_AU&referrer=utm_source%3Dquotemateapp.au%26utm_medium%3Dwebsite" className="btn btn-store btn-store-xs" aria-label="Get it on Google Play">
