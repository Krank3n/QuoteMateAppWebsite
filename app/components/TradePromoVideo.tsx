...
interface TradePromoVideoProps {
  tradeSlug: string;
  tradeName: string;
}

export default function TradePromoVideo({ tradeSlug, tradeName }: TradePromoVideoProps) {
    ...
    <div className="phone-mockup">
      ...
      <div className="phone-screen" onClick={handleVideoTap}>
        <video
          ...
          loop
          preload="none"
          poster={`/assets/videos/trades/${tradeSlug}-poster.jpg`}
          aria-label={`QuoteMate promo video for ${tradeName}`}
          style={{ width: '100%', height: 'auto', display: 'block' }}
        >
          <source src={`/assets/videos/trades/${tradeSlug}.webm`} type="video/webm" />
          <source src={`/assets/videos/trades/${tradeSlug}.mp4`} type="video/mp4" />
        </video>
