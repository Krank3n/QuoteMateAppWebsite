...
export const api = {
  ...
  mergeTicketPR: call<{ id: string; method?: string }>('adminMergeTicketPR'),
  dispatchEas: call<{ id: string; action: 'build' | 'submit' | 'update'; platform?: string; profile?: string; message?: string }>('adminDispatchEas'),
  generateReleaseNotes: call<{ id: string }>('adminGenerateReleaseNotes'),
