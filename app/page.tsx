          ...
          <div className="container">
            ...
            <div className="pricing-grid pricing-grid-3">
              ...
              <div className="pricing-card" data-reveal="">
                ...
                <a href="#" className="btn btn-secondary pricing-btn">Get Started Free</a>
              </div>
              {/* Pro Monthly */}
              <div className="pricing-card pricing-card-pro" data-reveal="">
                ...
                <a href="#" className="btn btn-primary pricing-btn">Subscribe to Pro</a>
              </div>
              {/* Pro Annual */}
              <div className="pricing-card pricing-card-annual" data-reveal="">
                ...
                <a href="#" className="btn btn-primary pricing-btn">Subscribe Annually</a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="platforms-grid">
              <div className="platform-card" data-reveal="">
                ...
                <h3>iOS</h3>
                <p>iPhone &amp; iPad</p>
                <a href="#" className="btn btn-store btn-store-sm" aria-label="Download on the App Store">
