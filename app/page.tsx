...
const faqItems = [
  ...
  { question: 'How does the free plan and trial work?', answer: "Sign up with no credit card. You're on the Free plan forever — send unlimited quotes and invoices, with customers paying online via Square. QuoteMate takes a 1.7% fee out of your payout — it is not added to your customer's bill — on top of Square's own processing fee. New users also get a 14-day Pro trial automatically when they create their first quote, so you can try every feature (bank/PayID/BPAY/PayPal options, AI material generation, all PDF templates, lower QuoteMate fee) before deciding whether to upgrade. Subscribe on iPhone or Android during the trial and the store gives you 14 days free before your first charge." },
