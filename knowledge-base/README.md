...
| 5 | **Square fees** | Free 1.7%; Pro **1.0% online / 1.5% in-person** (+ Square's own fee). The platform fee is `app_fee_money`, **deducted from the tradie's payout** (`shared/pdf/squareFees.ts`). The optional 2.9% surcharge was retired in Sep 2026 ahead of the RBA's 1 Oct 2026 ban; nothing changes what the customer is charged. | ✅ Fixed — the site said the 1.7% was "added to the customer's bill" (pricing page, home FAQ, JSON-LD, shower-quoting-tool, KB, directory listings). All now say it comes out of your payout, name it the QuoteMate fee rather than a "Square fee", and give the online/in-person split. |
